...
dataset = 'SRGNN/datasets/sample_train-item-views.csv'
...
if opt.dataset == 'diginetica':
    ...
    if not os.path.exists('SRGNN/sample'):
        os.makedirs('SRGNN/sample')
    pickle.dump(tra, open('SRGNN/sample/train.txt', 'wb'))
    pickle.dump(tes, open('SRGNN/sample/test.txt', 'wb'))
    pickle.dump(tra_seqs, open('SRGNN/sample/all_train_seq.txt', 'wb'))
